    ...
    <div class="w-100 overflow-hidden bg-gray-100" id="top">
      <div class="container position-relative">
        <div
          ...
          data-aos="fade-left"
          style="background-image: url(/frontend/img/webp/interior11.webp)"
        ></div>
        <div class="row">
            ...
            <div class="row gx-5 d-flex">
              <div class="col-md-11">
                <div
                  ...
                  data-aos="fade-right"
                  style="
                    background-image: url(/frontend/img/webp/people15.webp);
                    --bs-aspect-ratio: 50%;
                  "
                ></div>
              </div>
              <div class="col-md-5 offset-md-1">
                <div
                  ...
                  data-aos="fade-up"
                  style="
                    background-image: url(/frontend/img/webp/interior42.webp);
                  "
                ></div>
              </div>
              <div class="col-md-6">
                <div
                  ...
                  data-aos="fade-left"
                  style="
                    background-image: url(/frontend/img/webp/people4.webp);
                    --bs-aspect-ratio: 150%;
                  "
                ></div>
              </div>
      ...
      <div class="row d-flex justify-content-center align-items-center">
        ...
        <div class="col-md-7" data-aos="fade-left">
          <blockquote>
            ...
            <img
              src="/frontend/img/webp/person11.webp"
              width="64"
              height="64"
