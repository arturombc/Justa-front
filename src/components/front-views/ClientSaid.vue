      ...
      <div class="col-md-7" data-aos="fade-left">
        <blockquote>
          <div class="fs-4 my-3 fw-light pt-4 border-bottom pb-3">
            ...
            stuff I don´t understand. But I wear expensive Glasses and a
            Patagonia Hoodie. So I´am fine with it.”
          </div>
          <img
            ...
            data-aos="fade"
          />
          <span><span class="fw-bold">John Doe,</span> CEO of Stride Ltd.</span>
        </blockquote>
      </div>
    </div>
  </div>
