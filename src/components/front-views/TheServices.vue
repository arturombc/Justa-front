        ...
        <div class="col-md-6 col-lg-4 border-end" data-aos="fade-up">
          <div class="d-flex">
            ...
            <div class="col-md-9 flex-fill">
              ...
              <p>
                If we had any physical goods we would deliver them to your door
                steps. Of course in time and to the right adress. But we have no
                products...
              </p>
            </div>
          </div>
          ...
          <div class="d-flex">
            ...
            <div class="col-md-9 flex-fill">
              ...
              <p>
                ...
                ordered. But you can´t order anything here, so we can give you a
                100% gurantee that anything would be great!
              </p>
            </div>
          </div>
        </div>
